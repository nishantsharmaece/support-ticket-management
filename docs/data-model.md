...
**Scope:** Core only  
**Traces to:** [requirements-analysis.md](requirements-analysis.md), [architecture.md](architecture.md), [project-context.md](../tool-specific/cursor-workflow/project-context.md)
...
- Seed logic lives in Infrastructure (per architecture.md); this section documents strategy only
...
- Seed data description also documented in `database/setup-notes.md` (future artifact)
...
2. **Location** — migration files stored under Infrastructure Persistence folder; mirrored in `database/schema-or-migrations/` for assessment visibility
...
Operator-facing setup steps will be documented in `database/setup-notes.md` (future artifact).
